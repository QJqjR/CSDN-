...
<body>
	<div class="page-container">
		<font color="orange">&nbsp;&nbsp;${msg }</font>
		 <form class="form form-horizontal" id="form-article-add" action="PositionUpdateServlet" method="POST"> 
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>公司名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" id="businessname" name="businessname" value="${com.businessName }" readonly="readonly">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>招聘岗位：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${com.businessType }" id="businesstype" name="businesstype" >
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">发布日期：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text"  value="${com.businessTime }" name="datemin" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'datemax\')||\'%y-%M-%d\'}' })" id="datemin" class="input-text Wdate">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">招聘人数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  id="businessnum" name="businessnum" value="${com.businessNum }">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">工作地点：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${com.businessAdress }"  id="businessadress" name="businessadress">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">薪资范围：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${com.businessSalary }"  id="businesssalary" name="businesssalary">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">学历要求：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${com.businessEducation }" id="businesseducation" name="businesseducation">
			</div>
		</div>
		<div class="row cl">
	...
	<!--请在下方写此页面业务相关的脚本-->
	<script type="text/javascript"
		src="H-ui.admin-master/lib/jquery.validation/1.14.0/jquery.validate.js"></script>
	<script type="text/javascript"
		src="H-ui.admin-master/lib/jquery.validation/1.14.0/validate-methods.js"></script>
	<script type="text/javascript"
		src="H-ui.admin-master/lib/jquery.validation/1.14.0/messages_zh.js"></script>
	<script type="text/javascript"
		src="H-ui.admin-master/lib/webuploader/0.1.5/webuploader.min.js"></script>
	<script type="text/javascript">
